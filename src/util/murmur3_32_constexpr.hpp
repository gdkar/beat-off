#ifndef UTIL_MURMURHASH_3_CONSTEXPR
#define UTIL_MURMURHASH_3_CONSTEXPR
...
constexpr inline uint32_t _Murmur3_32(const char *const key, const size_t length,
...
constexpr inline uint32_t Murmur3_32(const char *const str,const uint32_t seed) noexcept {
  return _Murmur3_32(str, _StringLength(str), seed);
}
#endif
